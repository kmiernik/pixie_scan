...
protected:
    ...
    static double constexpr cycleTimePlotResolution_ = 1e-3;//!< Plot resolution for the Cycle time
    static double constexpr diffTimePlotResolution_ = 1e-6;//!< Plot resolution for the time diffs
};
